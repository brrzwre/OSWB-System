...
public class StockReportGenerator {
    ...
    public void generateReport(String itemsFile, String salesFile, String supplierFile, String outputPdf) throws IOException {
        try (PDDocument document = new PDDocument()) {
            ...
            items.sort(Comparator.comparing(o -> o[0]));  // Sort items by item code ascending
            ...
            try {
                ...
                // Print each item row with pagination
                for (String[] item : items) {
                    if (yPosition < PAGE_BOTTOM_MARGIN) {
                        // Close old content stream before new page
                        contentStream.close();
                    ...
                    // Set color: red if low stock else black
                ...
                try {
                    ...
                    // Print each supplier with pagination
